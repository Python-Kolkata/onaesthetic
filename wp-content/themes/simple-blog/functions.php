...
function my_jquery_enqueue() {
   ...
   wp_register_script('jquery', 'https://cdnjs.cloudflare.com/ajax/libs/jquery/1.10.2/jquery.min.js', false, null,false);
...
function simple_blog_scripts() {
	...
	wp_enqueue_style( 'googleapis-css', 'https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600;700;800&family=Roboto:wght@300;400;500;700&display=swap' );
